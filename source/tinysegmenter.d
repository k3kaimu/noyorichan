  ...
  private:
    ...
    shared static this()
    {
        ...
        UW2 = [",":-829,"、":-829,"〇":892,"「":-645,"」":3145,"あ":-538,"い":505,"う":134,"お":-502,"か":1454,
               ...
               "見":-3874,"調":1010,"議":1198,"込":3041,"開":1758,"間":-1257,"｢":-645,"｣":3145,"ｯ":831,"ｱ":-587,"ｶ":306,"ｷ":568];
        UW3 = [",":4889,"1":-800,"−":-1723,"、":4889,"々":-2311,"〇":5827,"」":2670,"〓":-3573,"あ":-2696,
               ...
               "間":1302,"関":-1282,"雨":2009,"電":-1045,"非":2066,"駅":1620,"１":-800,"｣":2670,"･":-3794,
               "ｯ":-1350,"ｱ":551,"ｸﾞ":1319,"ｽ":874,"ﾄ":521,"ﾑ":1109,"ﾙ":1591,"ﾛ":2201,"ﾝ":278];
        UW4 = [",":3930,".":3508,"―":-4841,"、":3930,"。":3508,"〇":4999,"「":1895,"」":3798,"〓":-5156,
               ...
               "館":-1984,"首":1749,"高":2120,"｢":1895,"｣":3798,"･":-4371,"ｯ":-724,"ｰ":-11870,"ｶ":2145,"ｺ":1789,
        ...
        UW5 = [",":465,".":-299,"1":-514,"E2":-32768,"]":-2762,"、":465,"。":-299,"「":363,"あ":1655,"い":331,
               ...
               "議":1219,"選":-1018,"郎":-368,"長":786,"間":1191,"題":2368,"館":-689,"１":-514,"Ｅ２":-32768,
               "｢":363,"ｲ":241,"ﾙ":451,"ﾝ":-343];
        UW6 = [",":227,".":808,"1":-270,"E1":306,"、":227,"。":808,"あ":-307,"う":189,"か":241,"が":-73,"く":-121,
               ...
               "業":-697,"相":753,"社":-507,"福":974,"空":-822,"者":1811,"連":463,"郎":1082,"１":-270,"Ｅ１":306,"ﾙ":-673,"ﾝ":-496];
        BW1 = [",と":660,",同":727,"B1あ":1404,"B1同":542,"、と":660,"、同":727,"」と":1682,"あっ":1505,
               ...
               "日本":-195,"本当":-2423,"毎日":-2113,"目指":-724,"Ｂ１あ":1404,"Ｂ１同":542,"｣と":1682];
        BW2 = ["..":-11822,"11":-669,"――":-5730,"−−":-13175,"いう":-1609,"うか":2490,"かし":-1350,"かも":-602,
               ...
               "本人":-2697,"東京":-1543,"然と":-1384,"社会":-1276,"立て":-990,"第に":-1612,"米国":-4268,"１１":-669];
        BW3 = ["あた":-2194,"あり":719,"ある":3846,"い.":-1185,"い。":-1185,"いい":5308,"いえ":2079,"いく":3029,
               ...
               "入り":1232,"大会":2217,"始め":1681,"市":965,"新聞":-5055,"日,":974,"日、":974,"社会":2024,"ｶ月":990];
    ...
    static immutable(char[dchar]) buildCharTypeMap()
    {
        ...
        foreach (dchar c; 'ｱ'..'ﾞ' + 1) { map[c] = 'K'; }
        foreach (dchar c; ['ー', 'ｰ']) { map[c] = 'K'; }

        // 'A' : [a-zA-Zａ-ｚＡ-Ｚ]
        foreach (dchar c; 'a'..'z' + 1) { map[c] = 'A'; }
        foreach (dchar c; 'A'..'Z' + 1) { map[c] = 'A'; }
        foreach (dchar c; 'ａ'..'ｚ' + 1) { map[c] = 'A'; }
        foreach (dchar c; 'Ａ'..'Ｚ' + 1) { map[c] = 'A'; }

        // 'N' : [0-9０-９]
        foreach (dchar c; '0'..'9' + 1) { map[c] = 'N'; }
        foreach (dchar c; '０'..'９' + 1) { map[c] = 'N'; }
